...
if mode_expt:
    ...
    conditions = ['B10','B200']#['B10','B50','B200']
else:
    directory = 'data_sim'
    conditions = ['low','medium','high']

subdirectory_plot = directory + '/analysis_poserror_comb'
    ...
    for mode_signals in [0]:
        ...
        for N_inc in range(1,N_var+1):
            ...
            for it_comb,comb in enumerate(combinations):
                ...
                bins_x,mean_x,var_x,pos_error,bins_x_sym,C_matrix_x = fns_plot.calc_profile_poserror(dataset[:,:,indices_comb],data.metricdist,N_bins_x,data.r_max)
