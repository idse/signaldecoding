...
if mode_expt == 'X7':
    ...
    file_name = subdirectory_data + '/' + 'expX7_data_bgsub_scaled_4_cols_250909' + '.csv'
if mode_expt == 'Z2':
    directory = 'data_expt_Z2'
    subdirectory_data = directory + '/data'
    file_name = subdirectory_data + '/' + 'expZ2_data_scaled_251002_6_cols' + '.csv'
    
#file_name = subdirectory_data + '/' + 'expX10_data_bgsub_scaled_normalized_4_cols_250818' + '.csv'
...
gene_names = ['ISL1','TFAP2C','SOX17_1','TBXT','NANOG','SOX2_2']
gene_names_simplified = ['ISL1','TFAP2C','SOX17','TBXT','NANOG','SOX2']
marker_names = []
...
N_cells_max = int(3*(N_entries/N_organoids_max))
