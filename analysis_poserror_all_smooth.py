...
subdirectory_plot = directory + '/analysis_poserror_all_smooth'
...
for it_cond,cond in enumerate(conditions):
    ...
    for mode_signals in [0,1]:
        ...
        bins_x,mean_x,var_x,pos_error,bins_x_sym,C_matrix_x = fns_plot.calc_poserror_smooth(dataset,data.metricdist,N_bins_x_raw,data.r_max,N_bins_x)
